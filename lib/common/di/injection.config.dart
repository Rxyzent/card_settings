...
import 'package:card_settings/data/settings/settings_api.dart' as _i368;
import 'package:card_settings/data/settings/settings_repo_impl.dart' as _i273;
...
import 'package:card_settings/domain/repo/settings_repo.dart' as _i766;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i368.SettingsApi>(() => _i368.SettingsApi(gh<_i361.Dio>()));
    gh.factory<_i766.SettingsRepo>(() => _i273.SettingsRepoImpl(
          gh<_i193.Storage>(),
          gh<_i368.SettingsApi>(),
        ));
    gh.factory<_i998.HomeCubit>(
        () => _i998.HomeCubit(gh<_i766.SettingsRepo>()));
    gh.factory<_i116.SettingsCubit>(
        () => _i116.SettingsCubit(gh<_i766.SettingsRepo>()));
    return this;
  }
}
