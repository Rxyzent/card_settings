...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/bank_logo.png
  AssetGenImage get bankLogo =>
      const AssetGenImage('assets/icons/bank_logo.png');

  /// File path: assets/icons/chip.png
  AssetGenImage get chip => const AssetGenImage('assets/icons/chip.png');

  /// File path: assets/icons/contactless.png
  AssetGenImage get contactless =>
      const AssetGenImage('assets/icons/contactless.png');

  /// File path: assets/icons/humo.png
  AssetGenImage get humo => const AssetGenImage('assets/icons/humo.png');
